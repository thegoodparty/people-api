import * as alb from "@pulumi/aws/types/enums/alb";
import * as applicationloadbalancing from "@pulumi/aws/types/enums/applicationloadbalancing";
import * as autoscaling from "@pulumi/aws/types/enums/autoscaling";
import * as ec2 from "@pulumi/aws/types/enums/ec2";
import * as iam from "@pulumi/aws/types/enums/iam";
import * as lambda from "@pulumi/aws/types/enums/lambda";
import * as rds from "@pulumi/aws/types/enums/rds";
import * as route53 from "@pulumi/aws/types/enums/route53";
import * as s3 from "@pulumi/aws/types/enums/s3";
import * as ssm from "@pulumi/aws/types/enums/ssm";
