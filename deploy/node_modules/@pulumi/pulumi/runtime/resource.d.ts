...
import { Inputs, Output } from "@pulumi/pulumi/output";
import { ResolvedResource } from "@pulumi/pulumi/queryable";
import { Alias, Resource, ResourceOptions, URN } from "@pulumi/pulumi/resource";
import * as aliasproto from "@pulumi/pulumi/proto/alias_pb";
 ...
 */
export declare function readResource(res: Resource, parent: Resource | undefined, t: string, name: string, props: Inputs, opts: ResourceOptions, sourcePosition?: SourcePosition, packageRef?: Promise<string | undefined>): void;
 ...
 */
export declare function registerResource(res: Resource, parent: Resource | undefined, t: string, name: string, custom: boolean, remote: boolean, newDependency: (urn: URN) => Resource, props: Inputs, opts: ResourceOptions, sourcePosition?: SourcePosition, packageRef?: Promise<string | undefined>): void;
/**
