...
const positions_schema_1 = require("./positions.schema");
let PositionsController = class PositionsController {
    positions;
    constructor(positions) {
        this.positions = positions;
    }
    async getPositionByBallotReadyId(params, query) {
...
__decorate([
    (0, common_1.Get)('by-ballotready-id/:brPositionId'),
    __param(0, (0, common_1.Param)()),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [positions_schema_1.GetPositionByBrIdParamsDTO,
        positions_schema_1.GetPositionByBrIdQueryDTO]),
    __metadata("design:returntype", Promise)
], PositionsController.prototype, "getPositionByBallotReadyId", null);
